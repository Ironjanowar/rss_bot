...
start: token
	_build/dev/rel/rss_bot/bin/rss_bot daemon
...
stop:
	_build/dev/rel/rss_bot/bin/rss_bot stop

attach:
	_build/dev/rel/rss_bot/bin/rss_bot remote

release: deps compile
	mix release

debug: token
	_build/dev/rel/rss_bot/bin/rss_bot console
